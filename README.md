...
tag     = "2.14.0"
modules = ["dist/hisab.cyr"]   # ~914 KB self-contained bundle (all 35 modules)
...
cyrius test tests/foundation.tcyr   # 367 foundation tests
cyrius test tests/modules.tcyr      # 1865 module tests
...
|--------|-------|
| Version | 2.14.0 |
| Library | 35 modules, ~23,738 lines of Cyrius |
| Tests | 3657 assertions across 5 suites |
