...
tag     = "2.15.0"
modules = ["dist/hisab.cyr"]   # ~944 KB self-contained bundle (all 35 modules)
...
cyrius test tests/modules.tcyr      # 1947 module tests
...
|--------|-------|
| Version | 2.15.0 |
| Library | 35 modules, ~24,172 lines of Cyrius |
| Tests | 3789 assertions across 5 suites |
