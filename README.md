...
tag     = "2.16.0"
modules = ["dist/hisab.cyr"]   # ~950 KB self-contained bundle (all 35 modules)
...
cyrius test tests/modules.tcyr      # 1965 module tests
...
|--------|-------|
| Version | 2.16.0 |
| Library | 35 modules, ~24,266 lines of Cyrius |
| Tests | 3807 assertions across 5 suites |
