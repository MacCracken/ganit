...
Suite **3572** across five harnesses (hisab 416, foundation 351, modules 1797, edge_cases 233,
abuse 775), constant gate **159/159**, **72** benchmarks, **35** `[lib]` modules, toolchain
...
| **2.13.0 — the suite release** | The **suite tier**: the `f64_to` truncation across ~843 assertion sites, plus the tolerance helpers three of five suites do not have | 2.12.0 |
...
- [ ] **The suite tier — the highest-value item in the whole audit, and now scheduled: 2.13.0.**
