...
dist/hisab.cyr       — full 35-module distlib bundle (899,733 B / 23,331 lines),
...
- **Toolchain pin**: `cyrius = "6.6.1"` in `cyrius.cyml`. CI and release both grep
