...
dist/hisab.cyr       — full 35-module distlib bundle (920,023 B / 23,614 lines),
...
- **Constant gate**: `./scripts/check-constants.sh` — decodes every hand-encoded hex f64 literal
  in `src/` and asserts it against the value in its own comment (154/154 verified, 1 skipped).
