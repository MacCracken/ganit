...
- **Constant gate**: `./scripts/check-constants.sh` — decodes every hand-encoded hex f64 literal
  in `src/` and asserts it against the value in its own comment (155/155 verified, 1 skipped).
